...
public class TabsFragmentActivity extends FragmentActivity implements TabHost.OnTabChangeListener {
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        TabsFragmentActivity.addTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab2").setIndicator("Game Status"), 
        		( tabInfo = new TabInfo("Tab2", TabFragment2.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
        
        TabsFragmentActivity.addTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab3").setIndicator("Players"), 
